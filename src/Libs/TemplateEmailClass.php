...
use App\Core\View;
use App\Models\CodigoValidadorModel;

class TemplateEmailClass
{
    ...
    public static function getTemplate($title=null, $subTitle=null, $description=null, $buttonLink=null, $buttonName=null):string
    {
        ...
        return (new TwigClass())->render("components/email",[
            "titleEmail" => self::$titleEmail,
            "subTitleEmail" => self::$subTitleEmail,
            "descriptionEmail" => self::$descriptionEmail,
            "buttonLinkEmail" => self::$buttonLinkEmail,
            "buttonNameEmail" => self::$buttonNameEmail,
